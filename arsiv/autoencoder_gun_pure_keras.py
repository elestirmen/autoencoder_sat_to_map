...
# load the dataset
data = load('C:/Users/ertug/OneDrive - Çukurova Üniversitesi/Terrain Relative Navigation/AutoEncoder_pix2pix/maps_256.npz')
...
# load image data
dataset = load_real_samples('C:/Users/ertug/OneDrive - Çukurova Üniversitesi/Terrain Relative Navigation/AutoEncoder_pix2pix/maps_256.npz')
...
# load dataset
[X1, X2] = load_real_samples(r'C:\Users\ertug\OneDrive - Çukurova Üniversitesi\Terrain Relative Navigation\AutoEncoder_pix2pix\maps_256.npz')
print('Loaded', X1.shape, X2.shape)
# load model
model = load_model(r'C:\Users\ertug\OneDrive - Çukurova Üniversitesi\Terrain Relative Navigation\AutoEncoder_pix2pix\model_103024.h5')
...
# load an image
def load_image(filename, size=(512,512)): #görüntününn boyutuna göre size yazılır
...
for modelname in listdir(yol_model):
    ...
    dosya=[]
    i=0
    for filename in listdir(yol):
        dosya.append(yol + filename) 
    ...
    # load source image
        ...
        cv2.imwrite("parcalar/goruntu{}.jpg".format(gen_image))    
