...
for bolunmus in liste1:
    ...
    #_______________________________________________________________________________________________________________#
        ...
        frame_adedi=int(np.sqrt(len(dosya)))  #klasörde kaç tane frame var sayısını getirir oluşturalacak görüntünün bir kenarındaki frame sayısı gibi
        ...
        cv2.imwrite("ana_haritalar/ana_harita_{}_{}_{}.jpg".format(harita,frame_adedi,modelname),son)        
